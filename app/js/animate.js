$(document).ready(function(){
  ...
  tl.from( $(".heading"), 1, { top: -100 },1 )
    .from( $(".mac__layer1"), 1, { display: 'none' , scale: 0 },"-=0.2" )
    ...
    .from( $(".navigation__partner"), 1, { display: "none" , top: 600 }, "-=0.2" )
    .from( $(".navigation__advertiser"), 1, { display: "none" , top: 600 }, "-=0.2" );
